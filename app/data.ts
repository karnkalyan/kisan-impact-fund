...
export const ventures: Venture[] = [
  ...
  {name:"Kisan Carbon Credit",sector:"Carbon and Climate",status:"Under Evaluation",problem:"Smallholders struggle to participate in climate markets.",solution:"Evaluate credible aggregation and measurement pathways.",benefit:"Potential climate incentives with robust safeguards.",focus:"To be confirmed"},
  {name:"Kisan Mart",sector:"Marketplaces",status:"Planned",problem:"Fragmented access to buyers and inputs.",solution:"A proposed farmer-centered commerce channel.",benefit:"Improved reach and price discovery.",focus:"To be confirmed"},
  ...
  {name:"Kisan Pay",sector:"Financial Services",status:"Under Evaluation",problem:"Farmers face gaps in accessible digital finance.",solution:"Explore compliant, partner-led financial tools.",benefit:"More inclusive transactions and services.",focus:"To be confirmed"},
